...
* Always commit your work and back it up with GitHub pushes. You don't want to lose hours of your work because you didn't push it to GitHub every half hour or so.
  ...
  * Ensure your repository has regular commits (i.e. 20+ commits) and a thorough README.md file
  ...
  #NOTE TO GRADER: I had to use my direct path to the folder in my python file because I couldn't get it to work otherwise. Also, I was unable to round the average change (in the PyBank challenge) down two decimals. Every time I tried it threw off the whole thing. 